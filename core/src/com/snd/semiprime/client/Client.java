...
import com.snd.semiprime.Packet;
...
import static com.snd.semiprime.Log.o;
...
public class Client
{
  ...
  public String email(String email) { o("email updated: " + email() + " -> " + email); return this.email.getAndSet(email); }

  public String username() { return username.get(); }
  public String username(String username) { o("username updated: " + username() + " -> " + username); return this.username.getAndSet(username); }
